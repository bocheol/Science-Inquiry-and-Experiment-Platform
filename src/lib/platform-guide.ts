...
export const PLATFORM_GUIDE_ENTRIES: GuideEntry[] = [
  ...
  { title: "공지·알림함", keywords: ["공지", "알림", "읽지 않음", "달력", "캘린더", "수정 요청", "푸시", "기기 알림", "거절", "차단", "다시 켜기"], answer: "교사는 공지 관리에서 전체·특정 반·특정 팀을 대상으로 일반 또는 중요 공지를 작성하고, 푸시를 허용한 대상 학생 기기로 알림을 보낼 수 있습니다. 학생은 공지·알림함에서 기기별 푸시를 직접 켜고 끕니다. 알림을 거절한 뒤 다시 로그인하면 `알림 다시 켜기` 버튼이 보이며, 기기 또는 브라우저 설정에서 과탐실 AI 알림을 허용한 뒤 이 버튼을 다시 누릅니다. 앱은 기기에서 차단한 권한 창을 강제로 다시 열 수 없습니다. iPhone·iPad는 Safari에서 홈 화면에 추가한 앱으로 열어야 푸시를 켤 수 있습니다. 잠금 화면에는 공지 내용이나 학생 정보가 표시되지 않습니다. 날짜 공지는 달력에도 표시되고, 계획서·보고서 수정 요청은 처리할 때까지 알림함에 유지됩니다." },
