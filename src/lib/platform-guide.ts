...
export const PLATFORM_GUIDE_ENTRIES: GuideEntry[] = [
  ...
  { title: "공지·알림함", keywords: ["공지", "알림", "읽지 않음", "달력", "캘린더", "수정 요청"], answer: "교사는 공지 관리에서 전체·특정 반·특정 팀을 대상으로 일반 또는 중요 공지를 작성할 수 있습니다. 날짜를 지정한 공지는 학생 공지·알림함 달력에도 표시되고, 중요 공지는 학생 로그인 뒤 팝업으로 안내됩니다. 계획서·보고서 수정 요청은 자동으로 알림함에 저장되며, 학생이 읽어도 다시 제출하기 전까지 처리 필요 상태가 유지됩니다." },
