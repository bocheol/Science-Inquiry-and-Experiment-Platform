...
export const PLATFORM_GUIDE_ENTRIES: GuideEntry[] = [
  ...
  { title: "준비물 신청", keywords: ["준비물", "시트", "구글", "예산", "5만원", "재전송", "모바일", "링크"], answer: "학생이 준비물 탭에서 품목을 제출하면 해당 학급 Google Sheet에 반영됩니다. 모바일 쇼핑 앱의 공유 문구를 붙여넣으면 지원 쇼핑몰은 PC 링크로 정리되며, 변환할 수 없는 모바일 전용 링크는 PC 웹 주소를 다시 복사하도록 안내합니다. 예산 상한 없이 신청 금액 그대로 전송하며 금액에 따른 별도 승인은 필요하지 않습니다. 조 영역이 없으면 확인된 학교 시트 양식 안에 영역과 합계를 만듭니다. 연동 실패 건은 교사 화면에서 확인할 수 있으며, 제출 당시 전송 위치 기록이 없는 옛 신청은 시트와 대조가 필요합니다." },
