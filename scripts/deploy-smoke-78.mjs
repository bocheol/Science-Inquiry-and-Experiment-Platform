...
assert.ok(['https://astra78---science-inquiry-platform-mx3s6ovg6a-du.a.run.app','https://science-inquiry-platform-974188506094.asia-northeast3.run.app'].includes(base));
...
await writeFile(`output/test-infra/deploy-${phase}-smoke-78.json`,JSON.stringify({base,phase,checkedAt:new Date().toISOString(),passed:results.length,results},null,2));
